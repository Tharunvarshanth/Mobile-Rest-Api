 ...
 */
class TitleView : Fragment() {
    var  listviewtitle:ListView?=null;
        ...
        if (getcall != null) {
            getcall.enqueue(object :Callback<List<UserRepositary?>?>{
                ...
                override fun onResponse(
                  ...
                  var  arrayAdapter = activity?.let { ArrayAdapter<String>(it,android.R.layout.simple_list_item_1,titlearray) }
                        listviewtitle=rootview!!.findViewById<ListView>(R.id.listview)

                        listviewtitle?.adapter=arrayAdapter
             ...
             rootview =inflater.inflate(R.layout.titleview_fragment, container, false)
        return rootview;
    }
